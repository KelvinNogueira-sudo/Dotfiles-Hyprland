...
hl.config({
	...
	-- Color Border --
        col = {
            active_border   = { colors = {"rgba(255, 0, 0, 0.88)"}, angle = 45 },
...
hl.bind(mainMod .. " + ESCAPE", hl.dsp.exec_cmd("wlogout -b 5 --margin-left=400px --margin-right=400px --margin-top=400px --margin-bottom=400px"))
